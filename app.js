    ...
    songs: [
        {
            ...
            path: "./music/AnhDauMuonThayEmBuon.mp3",
            image: "./img/anh1.jpg"
        },
        {
            name: "Bên trên tầng lầu",
            singer: "Tăng Duy Tân ",
            path: "./music/BenTrenTangLau.mp3",
            image: "./img/anh10.jpg"
        },
        {
            name: "Chuyện đời tôi",
            singer: "Raftaar x Brobha V",
            path: "./music/ChuyenDoiTa.mp3",
            image: "./img/anh3.jpg"
        },
        {
            name: "Nếu lúc đó",
        ...
        },
        {
            name: "Ngủ một mình ",
            singer: "Hiếu Thứ Hai",
            path: "./music/NguMotMinhtinhRatTinh.mp3",
            image: "./img/anh6.jpg"
        },
        {
            name: "See tình",
            singer: "Hoàng Thùy Linh",
            path: "./music/SeeTinh.mp3",
            image: "./img/anh7.jpg"
        },
        {
            name: "Bên nhau thật khó",
            singer: "Châu Khải Phong",
            path: "./music/BenNhauThatKho.mp3",
            image: "./img/anh2.jpg"
        },
        {
